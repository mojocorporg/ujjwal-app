...
import 'package:ujjwal/model/order_response_model.dart';
import 'package:ujjwal/model/payment_package_model.dart';
import 'package:ujjwal/model/return_model.dart';
import 'package:ujjwal/model/review_tag_model.dart';
import 'package:ujjwal/model/tag_model.dart';
...
class HomeRepo {
  Future<BusinessModel> getBusinessList(params) async {
    ...
    BusinessModel businessModel =
        BusinessModel.fromJson(jsonDecode(response.toString()));
  ...
  Future<ReviewTagModel> getReviewTags() async {
    ...
    ReviewTagModel tagModel =
        ReviewTagModel.fromJson(jsonDecode(response.toString()));
  ...
  Future<ReviewTagModel> postBusinessReview(params) async {
    var dio = Dio();
    Response response = await dio.post(ApiUrls.businessReview,
        options: Options(headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader: UserPreferences().getBearerToken(),
        }),
  ...
  Future<ReturnModel> addRemoveCard(params, id) async {
    var dio = Dio();
    Response response =
        await dio.post(ApiUrls.BASE_URL + "/business/${id}/add_to_my_list",
            options: Options(headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.acceptHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  UserPreferences().getBearerToken(),
            }),
            data: params);
    ReturnModel returnModel =
        ReturnModel.fromJson(jsonDecode(response.toString()));
  ...
  Future<ReturnModel> updateName(params) async {
    var dio = Dio();
    Response response = await dio.post(ApiUrls.updateName,
        options: Options(headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.acceptHeader: "application/json",
          HttpHeaders.authorizationHeader: UserPreferences().getBearerToken(),
  ...
  Future<PaymentPackageModel> getPackage() async {
    ...
    PaymentPackageModel data =
        PaymentPackageModel.fromJson(jsonDecode(response.toString()));
  ...
  Future<OrderResponseModel> getOrderId() async {
    ...
    OrderResponseModel data =
        OrderResponseModel.fromJson(jsonDecode(response.toString()));
  ...
  Future<ReturnModel> verifyPayment(params) async {
    var dio = Dio();
    Response response = await dio.post(ApiUrls.paymentVerification,
        options: Options(headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.acceptHeader: "application/json",
          HttpHeaders.authorizationHeader: UserPreferences().getBearerToken(),
